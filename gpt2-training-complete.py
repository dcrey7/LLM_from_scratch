...
def create_dataloader_v1(txt, batch_size=4, max_length=256, 
    ...
    # Create dataloader with fixed generator for reproducibility
...
if __name__ == "__main__":
    ...
    torch.cuda.manual_seed_all(123)  # if using multi-GPU
    ...
    # Create data loaders
    # No need to set seed here as it's already set at the beginning
    ...
    print(f"\nTotal batches in train loader: {len(train_loader)}")
    ...
    print(f"\nInitial Training loss: {train_loss}")
    ...
    # Sample 2: With temperature and top-k
    print("\nGeneration with temperature=1.4 and top_k=25:")
    torch.manual_seed(123)
    token_ids = generate(
        model=model.to(device),
        idx=text_to_token_ids("Every effort moves you", tokenizer).to(device),
